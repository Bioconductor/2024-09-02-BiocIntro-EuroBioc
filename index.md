...
helper: ["James Dalgleish"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
<ul>
  ...
  <li>Cost: <b>100 pounds</b> (covers cost of workshop and tea/coffee breaks)</li>

  <li>Places are limited to 25 participants, on a first-come
  first-serve basis.</li>

  <li>A confirmation email with payment detail will be sent on a
  weekly basis from 15 July onwards. <b>Registration will be final
